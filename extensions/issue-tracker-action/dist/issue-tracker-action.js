(() => {
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/admin/components/TextField/TextField.mjs
  ...
  function getIssues(productId) {
    return __async(this, null, function* () {
      var _a, _b, _c;
      const res = yield makeGraphQLQuery(
        `query Product($id: ID!) {
        product(id: $id) {
    ...
    `,
      ...
      if ((_c = (_b = (_a = res == null ? void 0 : res.data) == null ? void 0 : _a.product) == null ? void 0 : _b.metafield) == null ? void 0 : _c.value) {
